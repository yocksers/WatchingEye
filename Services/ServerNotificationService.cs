...
{
    public static class ServerNotificationService
    {
        ...
        public static void Start(ILogger logger, INotificationManager notificationManager)
        {
            ...
            _isRunning = true;
            _logger.Info("[ServerNotificationService] Started.");
        }

        public static void Stop()
        {
            _isRunning = false;
            _logger?.Info("[ServerNotificationService] Stopped.");
        }
        ...
        public static void SendLimitReachedNotification(string username, string clientName)
        {
            ...
            _logger?.Info($"[ServerNotificationService] Sent 'Time Limit Reached' notification for user {username}.");
        }
        ...
        public static void SendThresholdNotification(string username, string period, int threshold)
        {
            ...
            _logger?.Info($"[ServerNotificationService] Sent '{threshold}% threshold' notification for user {username}.");
        }
    }
}